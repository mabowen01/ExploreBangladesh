...
<head>
  ...
  <title>Tourist Attraction Management System</title>
...
<body>
    ...
    <div class="row">
      ...
      <div class="col-md-3 col-lg-2 d-md-block sidebar collapse bg-dark">
        <div class="position-sticky pt-3">
          <div class="text-center mb-4">
            <h4 class="text-white">Tourism Admin</h4>
          ...
          <ul class="nav flex-column">
            ...
            <li class="nav-item">
              <a class="nav-link active" href="#">
                <i class="bi bi-tree"></i> Attraction Management
              </a>
            </li>
            <li class="nav-item">
      ...
      <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 py-4">
        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
          <h1 class="h2">Tourist Attraction Management</h1>
          ...
          <div class="col-md-3">
            <div class="card bg-success text-white">
              <div class="card-body">
                <div class="d-flex justify-content-between align-items-center">
                  <div>
                    <h6 class="card-title">Active Attractions</h6>
        ...
        <div class="card mb-4">
          <div class="card-body">
            <div class="row">
              <div class="col-md-6">
                <a href="add_scenery.jsp" class="btn btn-primary">
              ...
              <table class="table table-hover align-middle">
                ...
                <tbody>
                  ...
                  <tr>
                    <td><%= rs.getInt("id") %></td>
                    <td>
                      <img src="../<%= imgPath %>" class="attraction-image" onerror="this.src='../images/default.jpg'"/>
                    </td>
                    <td>
                      <strong><%= rs.getString("name") %></strong>
                      <div class="text-muted small">Location: Unknown</div>
                    </td>
                    ...
                    <td class="action-btns">
                      <a href="edit_scenery.jsp?id=<%= rs.getInt("id") %>" class="btn btn-sm btn-outline-primary" data-bs-toggle="tooltip" title="Edit">
                        <i class="bi bi-pencil"></i>
                      </a>
                      <a href="delete_scenery.jsp?id=<%= rs.getInt("id") %>" class="btn btn-sm btn-outline-danger" onclick="return confirm('Are you sure you want to delete this attraction?')" data-bs-toggle="tooltip" title="Delete">
  ...
  <footer class="footer mt-auto py-3 bg-light">
    <div class="container">
      <div class="row">
        <div class="col-md-6">
          <span class="text-muted">© 2023 Tourism Management System</span>
        </div>
